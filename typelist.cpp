...
int main()
{
  ...
  // TypeAt
  static_assert(is_same<typename TypeAt<Len<l0>::value - 1, l0>::type, char>::value);
  // IsContain
  ...
  // PopFront
  static_assert(is_same<typename PopFront<l5>::type, TypeList<double, long, int>>::value);
  // PopBack
  static_assert(is_same<typename PopBack<l5>::type, TypeList<double, double, long>>::value);
  // Unique
  static_assert(is_same<typename Unique<l0>::type, TypeList<int, long, char>>::value);
  // ForEach
