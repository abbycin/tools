...
namespace nm
{
  ...
  public:
    ...
    public:
      ...
      Iterator(Iterator&& rhs) : co_{rhs.co_} { rhs.co_ = nullptr; }
      ...
      bool operator==(const Iterator& rhs) { return this->co_ == rhs.co_; }
    ...
    void yield() { new_sp_ = switch_stack(nullptr, new_sp_, nullptr); }
  ...
  private:
    ...
    void resume() { new_sp_ = switch_stack(nullptr, new_sp_, nullptr); }
